...
public class EventsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (role.equalsIgnoreCase(AppConstants.ROLE_SELF_CARE)) {
            String care_given_to = Prefs.getPreferences(getContext(), AppConstants.CARE_GIVEN_TO);
            tv_event_creator_name.setText(String.format("You are Creating events for %s", care_given_to));

        } else {
            tv_event_creator_name.setText("Events that are added to Calender");
