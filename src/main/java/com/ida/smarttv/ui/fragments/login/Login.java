            ...
            public void onChanged(LoginModel loginModel) {
                if (loginModel != null) {
                    ...
                    if (loginModel.getStatus().equalsIgnoreCase("200")) {
                        ...
                        Prefs.setPreferences(getContext(), AppConstants.USER_FULL_NAME, loginModel.getFullname());
                        Prefs.setPreferences(getContext(), AppConstants.USER_ROLE, loginModel.getRole());

                        if (loginModel.getOwnerFullname() != null && !loginModel.getOwnerFullname().isEmpty()) {
                            Prefs.setPreferences(getContext(), AppConstants.CARE_GIVEN_TO, loginModel.getOwnerFullname());
                        }
